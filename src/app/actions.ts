...
- lifeArea: одна з категорій: "career" (робота, проекти, кар'єра), "health" (спорт, здоров'я, медицина), "learning" (навчання, книги, курси), "relationships" (сім'я, друзі, стосунки), "hobby" (хобі, творчість, ігри), "personal" (особисте, побут, фінанси). Або null якщо незрозуміло.
